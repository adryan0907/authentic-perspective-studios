...
Ship web-optimized assets under each project folder (`cover.webp`, stills, and films under 100MB).

## Deferred films (not in git yet)

These exceed GitHub’s 100MB limit. Keep them local until compressed or replaced with Vimeo:

- `projects/woonboerderij/film.mp4`
